use utf8;
package ShinyCMS::Schema::Result::QueuedPaidEmail;
...
=head1 TABLE: C<queued_paid_email>

=cut

__PACKAGE__->table("queued_paid_email");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:I6Ff4FfDCctVEIHZB+2bcA
