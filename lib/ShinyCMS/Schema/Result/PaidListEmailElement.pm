use utf8;
package ShinyCMS::Schema::Result::PaidListEmailElement;
...
=head1 TABLE: C<paid_list_email_element>

=cut

__PACKAGE__->table("paid_list_email_element");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:O4CXFOzWjl36rkClBK+iGA
