...
insert into blog_post values ( 4, 2, 'Mmmm, content!',  '',     '2009-01-02 03:04:05' );
insert into blog_post values ( 5, 2, 'Hmmm, c0ntent?',  '',     '2009-05-04 03:02:01' );

insert into blog_post_discussion values ( 1, 1 );

insert into comment values ( 1, null, 1, 'denny', 'siteuser', null, null, 'First Post',  '', now() );
insert into comment values ( 2, null, 1, 'denny', 'siteuser', null, null, 'Second Post', '', now() );
insert into comment values ( 3, 1,    1, 'denny', 'siteuser', null, null, 'First Reply', '', now() );
insert into comment values ( 4, null, 1, 'denny', 'siteuser', null, null, 'Third, ish',  '', now() );
insert into comment values ( 5, 3,    1, 'denny', 'siteuser', null, null, 'Reply reply', '', now() );
